...
# импорт данных
df1 <- read.csv("C:/Users/Coder/OneDrive/Рабочий стол/RepoBigData/BigData/Lab8/LR8_dataset.csv", sep = "," , header = TRUE)

years=1989:2018

# выборка данных по данной стране
data_set <- df1[df1$Country.Name == "France", ]
...
# прирост людей с высшим образованием на рост экспорта товаров и на прирост высокотехнологичного производства
...
# корреляция методом Спирмана влияния высшего образования на прирост экспорта товаров
cor(Higher_education_growth,Growth_exports_goods, method= "spearman")
cor.test(Higher_education_growth,Growth_exports_goods )

# корреляция методом Пирсона влияния высшего образования на прирост экспорта товаров
cor(Higher_education_growth,Growth_exports_goods, method= "pearson")

# корреляция методом Спирмана влияния высшего образования на прирост высокотехнологичных товаров
...
# корреляция методом Пирсона влияния высшего образования на прирост высокотехнологичных товаров
