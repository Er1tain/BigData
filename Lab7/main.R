# Импорт данных всех спортсменов по всем видам спорта 
df <- read.table("C:/Users/Coder/OneDrive/Рабочий стол/RepoBigData/BigData/Lab7/athlete_events.csv", sep=",", header=TRUE)
